...
- Tempo and Loki ship on scratch images with no shell, so they have no container health check; Prometheus and Grafana still reach them, and `docker compose ps` will show them without a health column.
